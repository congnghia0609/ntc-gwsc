...
// 	uws.url = url.URL{Scheme: "ws", Host: addr, Path: "/ws/v1/ht/ETH_BTC"}
...
func StartHTWSClient() {
	var uws *UWSClient
	// var err error
	uws, _ = NewInstanceWSC(NameHTWSC, "ws", "localhost:15701", "/ws/v1/ht/ETH_BTC")
	defer uws.Close()
